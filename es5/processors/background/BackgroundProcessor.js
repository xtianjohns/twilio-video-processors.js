...
var BackgroundProcessor = /** @class */ (function (_super) {
    ...
    BackgroundProcessor._loadModel = function (config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var combinedConfig, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        combinedConfig = Object.assign({}, constants_1.MODEL_CONFIG, config);
                        _a = BackgroundProcessor;
                        return [4 /*yield*/, body_pix_1.load(combinedConfig)
     ...
     */
    BackgroundProcessor.prototype.loadModel = function (config) {
        return __awaiter(this, void 0, void 0, function () {
